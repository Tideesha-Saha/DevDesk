...
# === 2. Clean individual requirement ===
...
# === 4. Vectorize requirements using TF-IDF ===
...
# === 5. Wrapper function for Streamlit ===
def process_pdf_text(text):
    ...
    # requirements, vectors = process_pdf_text(text)
    project_status["requirements_extracted"] = len(requirements)
    project_status["last_update"] = datetime.now()
    project_status["notes"].append("Extracted requirements on " + str(datetime.now()))
